...
Simulation is an essential tool for fMRI method development, validation, and teaching. The `fmrireg` package offers several functions to simulate fMRI data with varying levels of complexity:
...
```{r, message=FALSE, fig.width=7, fig.height=9}
...
noise_long <- reshape2::melt(noise_df, id.vars = "Time", 
                            variable.name = "NoiseType", 
                            value.name = "Signal")
