...
* Shared AR estimation now pools voxel residual autocovariances by default
  ...
  `noise_spec(..., shared_estimator = "mean_series")`; this collapsed-series
  mode omits the OLS design correction because its voxel-level noise scale is
  no longer identifiable after averaging.
