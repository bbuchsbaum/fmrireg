...
resonance imaging (fMRI) time series. It provides a formula-based
interface for building event models, a rich library of hemodynamic
response functions, a flexible contrast system, and fast C++ solvers for
fitting GLMs.
