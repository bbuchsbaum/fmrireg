---
title: 12 Functional Connectivity (Seed-based)
...
vignette: |
  %\VignetteIndexEntry{12 Functional Connectivity (Seed-based)} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
---
