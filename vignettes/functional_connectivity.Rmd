...
vignette: |
  %\VignetteIndexEntry{Functional Connectivity (Seed-Based)} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
---
...
A rank-ordered view makes the signal easier to read than a gray histogram. The connected voxels are highlighted in red, so you can see where the injected network separates from the background.

```{r plot-connectivity-map}
