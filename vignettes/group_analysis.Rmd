---
title: "Group Analysis with fmrireg"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Group Analysis with fmrireg}
...
sfr <- spatial_fdr(fit_nii, coef = colnames(fit_nii$coefficients)[group_col], group = "blocks")
sum(sfr$reject)
