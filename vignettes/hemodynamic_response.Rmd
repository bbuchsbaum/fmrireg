...
vals1 <- evaluate(hrf2, seq(0,20,by=.1), duration=1)
vals2 <- evaluate(hrf2, seq(0,20,by=.1), duration=2)
vals3 <- evaluate(hrf2, seq(0,20,by=.1), duration=3)

plot(seq(0,20,by=.1), vals1, type="l", xlab="Time", ylab="BOLD response", ylim=range(c(vals1, vals2, vals3)), main="HRFs with Different Durations")
lines(seq(0,20,by=.1), vals2, type="l", col=2)
lines(seq(0,20,by=.1), vals3, type="l", col=3)
...
vals1 <- evaluate(hrf2, seq(0,20,by=.1), duration=1, summate=FALSE)
vals2 <- evaluate(hrf2, seq(0,20,by=.1), duration=2, summate=FALSE)
vals3 <- evaluate(hrf2, seq(0,20,by=.1), duration=3, summate=FALSE)

plot(seq(0,20,by=.1), vals1, type="l", xlab="Time", ylab="BOLD response", ylim=range(c(vals1, vals2, vals3)), main="Non-Summating HRFs with Different Durations ")
lines(seq(0,20,by=.1), vals2, type="l", col=2)
lines(seq(0,20,by=.1), vals3, type="l", col=3)
...
hrf_set <- do.call(gen_hrf_set,
                   lapply(seq(0,20,by=2), function(i) {  hrf_gaussian %>% gen_hrf_lagged(i) %>% HRF(name=paste0("lag_", i)) }))
