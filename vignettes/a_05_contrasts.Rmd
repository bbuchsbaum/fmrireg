---
title: 05 Contrasts and Hypothesis Tests
...
vignette: |
  %\VignetteIndexEntry{05 Contrasts and Hypothesis Tests} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
---
...
library(knitr)
library(ggplot2)
knitr::opts_chunk$set(collapse = TRUE, comment = "#>", fig.width=7, fig.height=6, message=FALSE, warning=FALSE)
```
...
```{r plot_contrasts_setup, include=FALSE}
# Build event model with contrasts for plotting
...
```{r plot_contrasts_example, error=TRUE}
...
- `vignette("benchmark_datasets", package = "fmrireg")` — Benchmark datasets
