...
In `fmrireg` it is not necessary to manually create regressors. Rather, regressors are created "behind the scenes" by the higher level modeling functions, such as `event_model`. However, the facility to create individual regressors, for the purposes of learning fMRI analysis or in conducting special analyses, may still be useful.
