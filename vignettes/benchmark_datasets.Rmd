...
vignette: |
  %\VignetteIndexEntry{06 Benchmark Datasets} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
---
...
knitr::opts_chunk$set(
  ...
  message = FALSE,
  warning = FALSE,
  fig.alt = "Figure illustrating dataset structure or evaluation results; see caption and text for details."
)
```
...
The `fmrireg` package ships a set of benchmark datasets designed for exactly this purpose. Each dataset provides controlled signal, noise, and experimental parameters so you can rigorously evaluate and compare analysis methods.
